 ...
 useEffect(() => {
    ...
    const fetchSMFileListData = async () => {
        ...
        try {
            ...
            const response = await fetch("https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/project/disptch/get_rejectedDispatchData_23.php", {
                method: "POST",
                body: formData,
            });
            ...
            console.error("Error fetching Rejected Dispatch File Details:", error);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading Rejected Dispatch File Details...</p>
                </div>
            </div>
        );
    }
                    ...
                    <Card.Header style={{
                        ...
                        <Row className="align-items-center">
                            <Col xs={12} lg={6} className="mb-2 mb-lg-0">
                                <h4 className="mb-0">
                                Rejected Dispatch File Details
                                </h4>
                        ...
                        {rowData.length === 0 ? (
                            ...
                            >
                                <AgGridReact
                                    ...
                                    onGridReady={(params) => {
                                        console.log('Rejected Dispatch File Details  Grid is ready');
