...
export default function PPCElectricalCompareMaterialToMaterDetails() {
  ...
  const tabs = [`Material Data ${fileName}`, "Material Master"];
  ...
  const fetchTabData = async (year) => {
    try {
      const res = await axios.get(
        `https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/PPC/getAssMaterialDataDetails.php?fileId=${fileId}`
      );
          ...
          >
            <Row className="align-items-center">
              <Col xs={12} lg={6} className="mb-2 mb-lg-0">
                <h4 className="mb-0">Assembly Material Compare details</h4>
              </Col>
              {/* Action Buttons */}
              <Col xs={12} lg={6}>
