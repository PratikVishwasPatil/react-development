...
// }, []);
            ...
            try {
                ...
                if (data.status === "success" && Array.isArray(data.data)) {
                    ...
                    if (years.length > 0) {
                        ...
                        setFinancialYear(latestYear.value);
                    }
                } else {
    ...
    const fetchSMFileListData = async (fy = financialYear) => {
        ...
        try {
            ...
            const response = await fetch("https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/project/disptch/get_completedDispatch_23.php", {
                method: "POST",
                body: formData,
            });
            ...
            console.error("Error fetching Completed Dispatch File List:", error);
...
const onSelectionChanged = (event) => {
    ...
    if (autoNavigateOnSelect && selectedData.length === 1) {
        ...
        setTimeout(() => {
            ...
            navigate(`/project/dispatch/completed-dispatch-details/${selectedRecord.file_id}`);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading Completed Dispatch File List...</p>
                </div>
            </div>
        );
    }
                            ...
                            >
                                <AgGridReact
                                    ...
                                    onRowClicked={(params) => {
                                        ...
                                        navigate(`/project/dispatch/completed-dispatch-details/${record.file_id}`);
                                      }}
                                    onGridReady={(params) => {
                                        console.log('Completed Dispatch File List  Grid is ready');
