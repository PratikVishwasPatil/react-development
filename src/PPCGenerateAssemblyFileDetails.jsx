...
const PPCGenerateAssemblyFileDetails = () => {
  ...
  const fetchPPCProjectDataDetails = async () => {
    ...
    try {
      const response = await fetch(
        "http://93.127.167.54/Surya_React/surya_dynamic_api/PPC/get_ProcessassemblyAssignMaterial_23.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          >
            ...
            >
              <div style={{ flex: isMobile ? "1 1 100%" : "1 1 auto" }}>
                ...
                >
                  <span>📋</span>
                  Generate Assembly File Details
                </h4>
...
export default PPCGenerateAssemblyFileDetails;
