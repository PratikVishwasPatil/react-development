...
function DynamicForm() {
    ...
    // Add new entry for a category (onladdCategoryEntryy if is_multiple is "yes")
    ...
    //                 axios.post('https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/insertData.php', submissionData1)
    //                     .then(res1 => {
    ...
    //                         axios.post('https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/insertData.php', submissionData2)
    //                             .then(res2 => {
