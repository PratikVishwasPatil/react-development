...
const MaterialStockAdjustList = () => {
    ...
    // API URLs
    const STOCK_API_URL = "https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/PPC/MaterialStockAdjustApi.php";
    ...
    const onSelectionChanged = (event) => {
        ...
        if (autoNavigateOnSelect && selectedData.length === 1) {
            ...
            setTimeout(() => {
                // Navigate to the material stock adjust detail page with FILE_ID
                navigate(`/ppc/material-stock-adjust/${selectedRecord.FILE_ID}`);
            }, 500);
        }
    };
    ...
    const onGridReady = (params) => {
        console.log('Material Stock Adjust List Grid is ready');
    ...
    const handleExportCSV = () => {
        if (gridRef.current && gridRef.current.api) {
            gridRef.current.api.exportDataAsCsv({
                fileName: `Material_Stock_Adjust_List_${selectedYear}_${new Date().toISOString().split('T')[0]}.csv`
            });
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading material stock adjust data...</p>
                </div>
            </div>
        );
    }
                    ...
                    <Card.Header style={{
                        ...
                        <Row className="align-items-center">
                            <Col xs={12} lg={6} className="mb-2 mb-lg-0">
                                <h4 className="mb-0">Material Stock Adjust List</h4>
                    ...
                    <Card.Body style={{
                        ...
                        {stockData.length === 0 ? (
                            <div style={{
                                ...
                                <h5>No material stock adjust data available</h5>
...
export default MaterialStockAdjustList;