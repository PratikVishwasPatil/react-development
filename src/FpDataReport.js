...
const FPDataConsolidatedReport = () => {
    ...
    const generateColumnDefs = () => {
        const baseColumns = [
            ...
            // Sheet Metal External
            {
                headerName: "Sheet Metal Ext",
                children: [
                    {
                        field: "ShM_Ext_WT",
                        headerName: "Weight",
            ...
            // Nut Bolt
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        width: 120,
                        valueFormatter: currencyFormatter,
                        cellStyle: { textAlign: 'right', fontWeight: '600', color: '#16a34a' },
                        type: 'numericColumn'
                    }
                ]
            },
            // Drive
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        width: 120,
                        valueFormatter: currencyFormatter,
                        cellStyle: { textAlign: 'right', fontWeight: '600', color: '#a855f7' },
                        type: 'numericColumn'
                    }
                ]
            },
            // Electrical
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        width: 120,
                        valueFormatter: currencyFormatter,
                        cellStyle: { textAlign: 'right', fontWeight: '600', color: '#f97316' },
                        type: 'numericColumn'
                    }
                ]
            },
            // Man Days
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        width: 120,
                        valueFormatter: currencyFormatter,
                        cellStyle: { textAlign: 'right', fontWeight: '600', color: '#06b6d4' },
                        type: 'numericColumn'
                    }
                ]
            },
            ...
            // Labour
            {
                ...
                width: 120,
                valueFormatter: currencyFormatter,
                cellStyle: { textAlign: 'right', fontWeight: '600', color: '#ec4899' },
                type: 'numericColumn'
            },
            // System
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        width: 120,
                        valueFormatter: currencyFormatter,
                        cellStyle: { textAlign: 'right', fontWeight: '600', color: '#14b8a6' },
                        type: 'numericColumn'
                    }
                ]
            },
    ...
    const fetchReportData = async (fy = financialYear, sdate = fromDate, edate = toDate) => {
        ...
        try {
            ...
            const url = `https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/summary_report/fp_data_consolidated_reportApi.php?${queryParams}`;
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p style={{ marginTop: '1rem', fontWeight: '600' }}>Loading FP data consolidated report...</p>
                    <style>{`
                        @keyframes spin {
