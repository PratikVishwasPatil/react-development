...
const FPDataConsolidatedReport = () => {
    ...
    const fetchReportData = async (from = '', to = '') => {
        ...
        try {
          ...
          const url = `https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/Report/get_Dispatch_Tran_rpt.php?${params}`;
    ...
    const getPinnedBottomRow = () => {
        ...
        const totals = rowData.reduce((acc, row) => {
            ...
            acc.transport_value += Number(row.transport_value || 0);
            acc.billing_amount += Number(row.billing_amount || 0);
            acc.actual_weight += Number(row.actual_weight || 0);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p style={{ marginTop: '1rem', fontWeight: '600' }}>Loading Dispatch Transport Report...</p>
                    <style>{`
                        @keyframes spin {
