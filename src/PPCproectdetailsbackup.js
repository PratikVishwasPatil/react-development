...
const ProjectDetailsManager = () => {
  ...
  const [advanceSelectedDepartment, setAdvanceSelectedDepartment] =
    useState("");
  const [showDrawingsPopup, setShowDrawingsPopup] = useState(false);
  const [drawingsSelectedDepartment, setDrawingsSelectedDepartment] =
    useState("");
...
useEffect(() => {
  ...
  if (hash) {
    ...
    // Fallback to pathname for browser routing
...
// Fetch sheet names - add fileId to dependency array
useEffect(() => {
  
  if (!fileId) return; // Don't fetch if fileId is not set yet
  ...
  fetchSheetNames();
}, [fileId]); // Add fileId here

// Fetch departments - add fileId to dependency array
useEffect(() => {
  if (!fileId) return; // Don't fetch if fileId is not set yet
  ...
  const displayDrawings =
    drawingsData.length > 0 ? drawingsData : uploadedDrawings;
...
const handleSendDrawings = async () => {
  ...
  try {
    // Map selected indices to actual doc_ids from the drawingsData
  ...
  return (
    ...
    />
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          <span>Project Details (S-25-084-SHI)</span>
          <div
            style={{
        ...
        >
          <span>Advance Copy (Long Lead Material)</span>
          <div
            style={{
              backgroundColor:
                mainTab === "advance-copy"
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    backgroundColor:
                      !selectedSheet || !selectedDepartment
                        ? "#ccc"
                        : "#ff5722",
                    color: "white",
                    cursor:
...
>
  ...
  style={{
    ...
    borderRadius: "6px",
    backgroundColor:
      !advanceSelectedSheet || !selectedDepartment
        ? "#ccc"
        : "#ff5722",
    color: "white",
    cursor:
...
>
  ...
  <div style={{ marginBottom: "24px" }}>
    ...
    <select
      ...
      onChange={(e) =>
        setDrawingsSelectedDepartment(e.target.value)
      }
      disabled={loadingDepts}
      style={{
        width: "100%",
  ...
  >
    ...
    <button
      ...
      style={{
        ...
        border: "none",
        borderRadius: "6px",
        backgroundColor: !drawingsSelectedDepartment
          ? "#ccc"
          : "#ff5722",
        color: "white",
        cursor: !drawingsSelectedDepartment
          ? "not-allowed"
          : "pointer",
        transition: "all 0.2s ease",
                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    style={{
                      ...
                      transition: "all 0.3s ease",
                      borderBottom:
                        activeTab === tab ? "4px solid #667eea" : "none",
                      boxShadow:
                        activeTab === tab
                          ...
                          <tr
                            ...
                            onMouseEnter={(e) => {
                              e.currentTarget.style.backgroundColor =
                                row.highlight ? "#ffe69c" : "#f8f9ff";
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.backgroundColor =
                                row.highlight ? "#fff3cd" : "transparent";
                            }}
                          >
                                  ...
                                  color:
                                    cellIdx === 0
                                      ...
                                      : cellIdx === 1
                                        ? "#2c3e50"
                                        : "#7f8c8d",
                                  textAlign: cellIdx <= 1 ? "left" : "center",
                                  minWidth:
                                    cellIdx === 1
                                      ? "250px"
                                      : cellIdx <= 3
...
>
  ...
  >
    ...
    Uploaded Drawings (S-25-084-SHI)
  </h3>
  <div
    style={{
      background:
                  ...
                  >
                    {displayDrawings.map((drawing, idx) => (
                      <div
                        ...
                        style={{
                          display: "grid",
                          gridTemplateColumns: "140px 130px 1fr 85px 45px",
                          alignItems: "center",
                          gap: "16px",
                          padding: "16px 18px",
                          background:
                      ...
                      {displayHistory.length > 0 && (
                        <div
                          style={{
                            ...
                            width: "3px",
                            background:
                              "linear-gradient(180deg, #667eea 0%, #e9ecef 100%)",
                          }}
                        />
                      )}
                        ...
                        displayHistory.map((item, idx) => (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <span style={{ color: "#7f8c8d" }}>From:</span>{" "}
                                {item.sender}
                              </div>
