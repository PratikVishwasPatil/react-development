...
const fetchFinancialYears = async () => {
    try {
        ...
        if (data.status === "success" && Array.isArray(data.data)) {
            ...
            // Set the latest year as default (last item in the array, excluding 'all')
    ...
    const fetchSMFileListData = async (fy = financialYear) => {
        ...
        try {
            ...
            const response = await fetch("https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/sm_file_list_api.php", {
                method: "POST",
                body: formData,
            });
            ...
            console.error("Error fetching SM file list data:", error);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading SM file list data...</p>
                </div>
            </div>
        );
    }
                        ...
                        {rowData.length === 0 ? (
                            ...
                            >
                                <AgGridReact
                                    ...
                                    onGridReady={(params) => {
                                        console.log('SM File List Grid is ready');
