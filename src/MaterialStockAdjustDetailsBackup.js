  ...
  const fetchData = async (fileId) => {
    try {
      ...
      const response = await fetch(
        `https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/PPC/MaterialStockAdjustDetailsApi.php?financial_year=${financialYear}&fileId=${fileId}`
      );
              ...
              <Table hover responsive style={{ marginBottom: 0 }}>
                <thead style={{
                  ...
                  <tr>
                    ...
                    <th style={{ padding: '16px', width: '100px' }}>Sr.No</th>
                    <th style={{ padding: '16px', minWidth: '350px' }}>Material Description</th>
                    <th style={{ padding: '16px', width: '140px', textAlign: 'center' }}>Unit</th>
                    <th style={{ padding: '16px', width: '140px', textAlign: 'center' }}>Quantity</th>
                    <th style={{ padding: '16px', width: '140px', textAlign: 'center' }}>Remaining</th>
                  </tr>
                </thead>
                <tbody>
