...
const PPCReceivedMaterialDetailsAssembly = () => {
  ...
  const fetchPPCProjectDataDetails = async () => {
    ...
    try {
      const response = await fetch(
        "http://93.127.167.54/Surya_React/surya_dynamic_api/PPC/get_ReceviedMaterialListAssly_23.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const autoSizeAll = () => {
    ...
    console.log("autosize button clicked");
  };
          ...
          >
            ...
            >
              <div style={{ flex: isMobile ? "1 1 100%" : "1 1 auto" }}>
                ...
                >
                  <span>📋</span>
                  Assembly Received Material Details
                </h4>
...
export default PPCReceivedMaterialDetailsAssembly;
