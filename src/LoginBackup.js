...
function Login() {
  ...
  useEffect(() => {
    const fetchFinancialYears = async () => {
      try {
        const response = await axios.get('http://93.127.167.54/Surya_React/surya_dynamic_api/GetYearsApi.php');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Make the API call
      const response = await axios.post('http://93.127.167.54/Surya_React/surya_dynamic_api/login.php', loginData, {
        headers: {
