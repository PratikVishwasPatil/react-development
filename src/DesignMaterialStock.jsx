...
const DesignMaterialStock = () => {
  ...
  const fetchMaterialStockData = async () => {
    setLoading(true);
    try {
      const response = await fetch(
        "https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/common/getMaterialStock_23.php",
        {
          method: "POST",
          headers: {
          ...
          >
            <Row className="align-items-center">
              <Col xs={12} lg={6} className="mb-2 mb-lg-0">
                <h4 className="mb-0">Material Master and Stock</h4>
...
export default DesignMaterialStock;
