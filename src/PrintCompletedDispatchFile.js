 ...
 useEffect(() => {
    ...
    const fetchSMFileListData = async (fy = financialYear) => {
        ...
        try {
            ...
            const response = await fetch("https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/project/disptch/get_printCompletedDispatchFile_23.php", {
                method: "POST",
                body: formData,
            });
            ...
            console.error("Error fetching Print Completed Dispatch File List:", error);
...
const onSelectionChanged = (event) => {
    ...
    if (autoNavigateOnSelect && selectedData.length === 1) {
        ...
        setTimeout(() => {
            ...
            navigate(`/project/dispatch/print-completed-dispatch-details${selectedRecord.file_id}`);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading Print Completed Dispatch File List...</p>
                </div>
            </div>
        );
    }
                    ...
                    <Card.Header style={{
                        ...
                        <Row className="align-items-center">
                            <Col xs={12} lg={6} className="mb-2 mb-lg-0">
                                <h4 className="mb-0">
                                Print Completed Dispatch File List
                                </h4>
                            ...
                            >
                                <AgGridReact
                                    ...
                                    onRowClicked={(params) => {
                                        ...
                                        navigate(`/project/dispatch/print-completed-dispatch-details/${record.file_id}`);
                                      }}
                                    onGridReady={(params) => {
                                        console.log('Print Completed Dispatch File List  Grid is ready');
