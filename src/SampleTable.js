...
const GridExample = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            } else if (formattedTitle === 'Allowance Master List') {
                newFormName = 'Allowance Master';
            } else if (formattedTitle === 'Vendor') {
                newFormName = 'Vendor';
            } else if (formattedTitle === 'Reminder List') {
                newFormName = 'Add Reminder';
            } else if (formattedTitle === 'Mom List') {
                newFormName = 'Add Mom';
            ...
            let requestPayload1 = [];
            if (formattedTitle === 'Compansy List') {
    ...
    const handleEditRow = () => {
        ...
        // Determine the route based on the form title
        let editRoute = '';
        let routeFormTitle = '';

        switch (formattedTitle) {
            case 'User List':
                editRoute = `/add-user/${selectedRow.id}`;
                routeFormTitle = 'Add User';
                break;
            case 'Company List':
                editRoute = `/add-company/${selectedRow.id}`;
                routeFormTitle = 'Add Company';
                break;
            case 'Allowance Master List':
                editRoute = `/allowance-master/${selectedRow.id}`;
                routeFormTitle = 'Allowance Master';
                break;
            case 'vendor':
                editRoute = `/vendor/${selectedRow.id}`;
                routeFormTitle = 'Vendor';
                break;
            case 'Reminder List':
                editRoute = `/reminder-list/${selectedRow.id}`;
                routeFormTitle = 'Reminder List';
                break;
                 case 'Nc List':
                editRoute = `/nc-list/${selectedRow.id}`;
                routeFormTitle = 'Nc List';
                break;
            case 'Student List':
                editRoute = `/add-student/${selectedRow.id}`;
                routeFormTitle = 'Add Student';
                break;
            default:
                // Generic fallback route
                editRoute = `/edit-record/${selectedRow.id}`;
                routeFormTitle = formTitle;
                break;
        }
    ...
    const handleDeleteRows = async () => {
        ...
        if (formattedTitle === 'User List') {
            ...
            newFormName = 'Add Company';
        } else if (formattedTitle === 'Allowance Master') {
            newFormName = 'Allowance Master';
        } else if (formattedTitle === 'Vendor') {
            newFormName = 'Vendor';
        } else if (formattedTitle === 'Reminder List') {
            newFormName = 'Reminder List';
        } else if (formattedTitle === 'Mom List') {
            newFormName = 'Add Mom';
        } else if (formattedTitle === 'Nc List') {
                newFormName = 'Add Nc';
