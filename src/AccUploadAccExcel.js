...
const ManufacturingDataYearlyGrid = () => {
    ...
    // Fetch Account Data Data list data
    const fetchManufacturingDataYearly = async () => {
      try {
        const res = await axios.get(
          "https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/account/get_Acc_excel_file_23.php"
        );
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p style={{ marginTop: '1rem' }}>Loading Account Data Data...</p>
                </div>
            </div>
        );
    }
        ...
        <div style={{
            ...
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0">
                <Accordion.Header>Upload Yearly Account Dataa</Accordion.Header>
                <Accordion.Body>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
                            <div style={{ flex: isMobile ? '1 1 100%' : '1 1 auto' }}>
                                <h4 style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    <span>📋</span>Upload Account Data</h4>
                    ...
                    <div style={{
                        ...
                        {rowData.length === 0 && !loading ? (
                            <div style={{
                                ...
                                <h5>No Account Dataa available</h5>
                                   {/* Last uploaded time */}
      {lastUpdated && (
