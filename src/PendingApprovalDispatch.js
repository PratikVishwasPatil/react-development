 ...
 useEffect(() => {
    ...
    const fetchSMFileListData = async (fy = financialYear) => {
        ...
        try {
            ...
            const response = await fetch("https://www.erp.suryaequipments.com/Surya_React/surya_dynamic_api/project/disptch/getpendingDispatchFile_23.php", {
                method: "POST",
                body: formData,
            });
...
const onSelectionChanged = (event) => {
    ...
    if (autoNavigateOnSelect && selectedData.length === 1) {
        ...
        setTimeout(() => {
            ...
            navigate(`/project/dispatch/print-completed-dispatch-details${selectedRecord.fileid}`);
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center', color: themeStyles.color }}>
                    ...
                    <p className="mt-3">Loading Pending Dispatch File List...</p>
                </div>
            </div>
        );
    }
                            ...
                            >
                                <AgGridReact
                                    ...
                                    onRowClicked={(params) => {
                                        ...
                                        navigate(`/project/dispatch/pending-approve-dispatch-details/${record.fileid}`);
                                      }}
                                    onGridReady={(params) => {
                                        console.log('Pending Dispatch File List Grid is ready');
